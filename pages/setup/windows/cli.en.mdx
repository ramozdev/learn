...
I recommend you install and use the [Windows Linux Subsystem](https://learn.microsoft.com/windows/wsl/install). This will greatly simplify working with the terminal in your computer.

## Start

Press `Ctrl + Alt + T` to open a terminal window. Or you can search for `terminal` in the search bar.
...
Expect a path of the form `/home/username`. This is the path to your home directory.

Now we use the `ls` command to see the content of the current directory.
...
To go back, you must use the `..` syntax which indicates the parent directory of the current working directory. For example, `cd ..` will take you to `/home/username`
